...
/// в TexFi f0kus): узнаваемые формы на сетке 8×8, без сглаживания и
/// лишней детализации — категории, таббар, иконки настроек.
///
/// Каждый спрайт — 8 строк по 8 символов: `#` — закрашенный пиксель,
/// любой другой символ — пусто. Ключи для категорий совпадают с ключами
/// [CategoryIcons] в `core/constants/category_icons.dart`, чтобы отрисовка
/// подтягивалась прямо по `CategoryEntity.iconKey`.
